using LinearAlgebra, Distributions, Random, SparseArrays, Plots, Statistics, MultivariateStats
...
function simulate(n, iteration)
    ...
    # generate test data
    X_test = (U *  hcat([rand(mvn) for _ in 1:5000]...))'
    ...
    # calculate RMSE and coverage probability
